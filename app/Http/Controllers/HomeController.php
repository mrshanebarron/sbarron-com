...
class HomeController extends Controller
{
    ...
    private function liveClients(): array
    {
        return [
            [
                ...
                'stack' => 'Laravel · Livewire · MySQL · Square',
            ],
            [
                'slug' => 'easyquit',
                'name' => 'EasyQuit',
            ...
            [
                ...
                'tag' => 'In production',
                'summary' => 'Service-business site with three custom plugins replacing four off-the-shelf ones — lighter, faster, easier for the operator.',
            ...
            [
                ...
                'kind' => 'Editorial blog',
                'tag' => 'In production',
                'summary' => 'High-protein recipe blog with a custom Kadence-replacing theme and Kit (ConvertKit) newsletter integration.',
                'url' => 'https://restdaykitchen.com',
                'image' => '/portfolio/port-restday.png',
                'stack' => 'WordPress · custom theme · Kit',
            ],
        ];
    }
    ...
    private function mvpShowcase(): array
    {
        return [
            ...
            ['slug' => 'leggings',     'name' => 'FitForm Edit',            'kind' => 'Editorial affiliate review',   'category' => 'editorial', 'summary' => 'The best gym leggings, tested honestly — 14 pairs across squat racks, hot yoga, half-marathon training.',  'url' => 'https://leggings-affiliate.mvp.sbarron.com','image' => '/portfolio/port-leggings.png'],
